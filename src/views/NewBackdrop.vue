...
export default Vue.extend({
  ...
  data() {
    return {
      ...
      blurb1_text: `At DeltaHacks, we believe change comes from dreaming big. Each year we enable hundreds of students from across the globe, working hard over 36 hours, to bring their big ideas to life. Our team works diligently year round to provide a welcoming atmosphere to all of our participants. DeltaHacks gives you the platform to make an idea a reality, whether it be with a team, or on your own. Unleash your creativity and make something great, we'll handle the rest! Make big ideas a reality at DeltaHacks 8!`,
      blurb1_button: `DeltaHacks 7 DevPost`,
      blurb1_link: `https://deltahacks7.devpost.com/`,
      blurb2_text: `DeltaHacks is the annual hackathon for change, it's even in the name! The primary focus of DeltaHacks is to enable hackers from all over to make a change, whether it be in education, finance, health or any other field, we're extremely passionate about hacking to make a positive change! We work with McMaster University to welcome hackers of all levels, from the novice to the most experienced! We supply the prizes, venue, and workshops to provide even the most seasoned veterans with new experiences. Now in our 8th year running, DeltaHacks 8 is our biggest and best DeltaHacks yet. Join us in January and take part in an experience you won’t forget!`};
  },
  methods: {
